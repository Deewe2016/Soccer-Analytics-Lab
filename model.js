...
function predictMatch(team1Stats,team2Stats,venue="neutral"){
 ...
 if(venue==="home") venueAdjustment=0.18;
 else if(venue==="away") venueAdjustment=-0.18;
 ...
 const expectedGoals1=Math.max(0.15,1.05+(attack1-defense2)*0.55+eloDifference*0.20+team1.form*0.03+venueAdjustment);
 const expectedGoals2=Math.max(0.15,1.05+(attack2-defense1)*0.55-eloDifference*0.20+team2.form*0.03-venueAdjustment);
